...
class MultiPackSentenceReaderTest(unittest.TestCase):
    ...
    @data(
        ("This file is used for testing MultiPackSentenceReader.", 1),
        (
    ...
    def test_parse_pack(self, text, annotation_length):
        ...
        self.assertEqual(len(list(input_pack.all_annotations)), annotation_length)
        self.assertEqual(input_pack.text, text + "\n")

    @data(
        (
            [
                "This file is used for testing MultiPackSentenceReader.",
