...
class HTMLReaderPipelineTest(unittest.TestCase):
    def setUp(self):
        ...
        self.reader = HTMLReader(
            cache_directory=self._cache_directory, append_to_cache=True
        )
        ...
        self.pl2.set_reader(
            HTMLReader(from_cache=True, cache_directory=self._cache_directory)
        )
        self.pl2.initialize()
    ...
    def test_reader_with_dir(self):
        ...
        maybe_download(
            "https://www.yahoo.com/", tmp_dir.name, "test_yahoo.html"
        )
