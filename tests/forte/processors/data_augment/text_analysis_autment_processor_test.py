...
from forte.processors.data_augment.text_analysis_augment_processor import TextAnalysisDataAugmentProcessor
...
class TestTextGenerationAugmentProcessor(unittest.TestCase):
    ...
    def test_pipeline(self, texts):
        ...
        processor = TextAnalysisDataAugmentProcessor()
        ...
        for idx, m_pack in enumerate(nlp.process_dataset(self.test_dir)):
            self.assertEqual(m_pack.get_pack("aug_0").text, expected_outputs[idx])
