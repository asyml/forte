...
class DummyAugmenter(SkeletonOp):
    ...
    def augment(self, input_pack: DataPack) -> bool:
        try:
            ...
            new_text_1 = "There"
            new_text_2 = "Avoid"
            insert_attempt_1 = self.insert_annotations(
                new_text_1, input_pack, 5
            )
            insert_attempt_2 = self.insert_annotations(
                new_text_2, input_pack, 5
            )
...
class TestSkeletonOp(unittest.TestCase):
    ...
    def test_operations(self) -> None:
        ...
        self.assertEqual(list(delete_list[data_pack.pack_id]), [token_1.tid])
