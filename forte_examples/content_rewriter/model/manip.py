...
from forte_examples.content_rewriter.model.copy_net import CopyNetWrapper
from forte_examples.content_rewriter.model.utils_e2e_clean import (
    x_strs,
    x_fields,
    y_strs,
    ...
    def load_model(self):
        ...
        with self.sess.graph.as_default():
            ...
            while epoch < Config.config_train.max_epochs:
                ...
                self.train_epoch(self.sess, self.summary_writer, 'train',
                                 train_op,
                                 summary_op)
