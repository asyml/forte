...
from forte_examples.Cliner.CliNER.code import tools
from forte_examples.Cliner.CliNER.code.model import ClinerModel
from forte_examples.Cliner.CliNER.code.notes.documents import Document
