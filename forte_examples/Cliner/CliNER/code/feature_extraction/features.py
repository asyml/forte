...
from forte_examples.Cliner.CliNER.code.feature_extraction import \
    word_features as feat_word
from forte_examples.Cliner.CliNER.code.feature_extraction.read_config import \
    enabled_modules
# What modules are available
from forte_examples.Cliner.CliNER.code.feature_extraction.utils import load_pos_tagger
...
feat_genia = None
if enabled['GENIA']:
    from forte_examples.Cliner.CliNER.code.feature_extraction.genia_dir\
...
if enabled['UMLS']:
    ...
    from forte_examples.Cliner.CliNER.code.feature_extraction.umls_dir.umls_cache \
        import UmlsCache
