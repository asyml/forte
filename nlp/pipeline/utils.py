...
def get_full_module_name(o, lower=False):
    """
    Returns the full module path and class name of an object o.
    For example, for
    :class:`~nlp.pipeline.data.readers.ontonotes_reader.OntonotesReader`,
    returns `"nlp.pipeline.data.readers.ontonotes_reader.OntonotesReader"`,
    """
