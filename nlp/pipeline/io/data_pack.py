...
class DataIndex:
    ...
    def _have_overlap(self,
        ...
        if not isinstance(entry1, Annotation):
            raise TypeError(f"The type of 'entry1' should be Annotation,"
        ...
        if not isinstance(entry2, Annotation):
            raise TypeError(f"The type of 'entry2' should be Annotation,"
                            f" but get {type(entry2)}")

        return (entry1.span.begin >= entry2.span.end or
...
class DataPack:
    ...
    def _generate_annotation_entry_data(
        ...
        # TODO: (Wei Wei) simplify code with bisect
        ...
        anno_begin_index, anno_end_index = valid_begin_index, len(
            self.annotations)
        ...
        print(valid_begin_index, valid_end_index)
