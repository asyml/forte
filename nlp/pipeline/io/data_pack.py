...
class DataIndex:
    def __init__(self):
        ...
        self.coverage_index_switch = False
...
class DataPack:
    ...
    def _generate_annotation_entry_data(
        ...
        if sent:
            valid_annotation = self.index.coverage_index["Sentence-to-Entry"][sent.tid]
    ...
    def _generate_link_entry_data(
        ...
        # ``a_type`` annotations generated by ``component`` in this ``sent``
        if sent:
            valid_link = self.index.coverage_index["Sentence-to-Entry"][sent.tid]
