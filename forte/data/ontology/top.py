...
class Annotation(Entry):
    ...
    def get(
        ...
        Example:
            ...
            In the above code snippet, we get entries of type :class:`~ft.onto.base_ontology.Token` within
...
class Query(Generics):
    ...
    Args:
        pack (DataPack): Data pack reference to which this query will be added
    """
