...
class DataStore(BaseStore):
    ...
    def __init__(self, onto_file_path=None):
        ...
        [<member_type>, <[members_tid_list]>, <tid>, <entry_type>, <attr_1>, <attr_2>, ...,
        <attr_n>].
        Link type entry has the following format:
        [<parent_tid>, <child_tid>, <tid>, <entry_type>, <attr_1>, <attr_2>, ..., <attr_n>].

        The first four fields are compulsory for every `entry data`.
    ...
    def _new_annotation(self, type: str, begin, end):
        """
        generate a new annotation with default fields. Called by add_annotation_raw()
    ...
    def get(
        ...
        typeID = self._type_dict[entry_type]
        yield from self.elements[typeID]
