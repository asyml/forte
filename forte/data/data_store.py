...
class DataStore(BaseStore):
    ...
    def _parse_onto_file(self):
        r"""If a user provides a customized ontology json file, forte will parse
        this file and set the dictionary `self._type_attributes` to store type name,
        parent entry, and its attribute information,accordingly. It not only
