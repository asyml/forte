...
class DataStore(BaseStore):
    ...
    def __init__(self, onto_file_path: Optional[str] = None):
        ...
        `Entry_type` is the type of this entry. `tid` is an unique id of every entry,
        ...
        types that inherit the `Entry` class. Currently, they are all
        defined in ft.onto and ftx.onto.
    ...
    def _new_annotation(self, type: str, begin: int, end: int):
    ...
    def delete_entry(self, tid: int):
        ...
        # `entry_type`, `type_id`, begin and end indices. Remove the entry from
