...
latex_documents = [
    (master_doc, 'forte.tex', u'Forte Documentation',
     u'Forte', 'manual'),
]
...
man_pages = [
    (master_doc, 'forte', u'Forte Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'forte', u'Forte Documentation',
     author, 'Forte', 'One line description of project.',
     'Miscellaneous'),
]
...
# https://docs.readthedocs.io/en/latest/faq.html#i-get-import-errors-on
# -libraries-that-depend-on-c-modules
