# -*- coding: utf-8 -*-
#
# forte documentation build configuration file, created by
...
intersphinx_mapping = {
    ...
    "texar_pytorch": ("https://texar-pytorch.readthedocs.io/en/latest/", None)
    # 'numpy': ('http://docs.scipy.org/docs/numpy/', None),
}

extlinks = {
    "torch_docs": ("https://pytorch.org/docs/stable/%s", None),
    "torch": ("https://pytorch.org/docs/stable/torch.html#torch.%s", "torch."),
    "torch_nn": (
...
nbsphinx_execute = "never"  # it shows output kept in the notebook
