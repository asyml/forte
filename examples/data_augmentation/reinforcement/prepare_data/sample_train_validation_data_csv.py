...
# Sample from IMDB dataset for fewer insntances to train the da_rl model.
...
read_train_csv("data/IMDB/train.csv", "data/IMDB/train_rl.csv",
               "data/IMDB/eval_rl.csv", train_POS, train_NEG,
               eval_POS, eval_NEG)
