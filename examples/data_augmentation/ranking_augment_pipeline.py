...
from forte.processors.data_augment import RankingDataAugmentProcessor
...
if __name__ == "__main__":
    ...
    nlp.add(RankingDataAugmentProcessor(), config=config.augment_query)
    nlp.add(ElasticSearchQueryCreator(), config=config.query_creator)
    nlp.add(ElasticSearchProcessor(), config=config.indexer)
    nlp.add(RankingDataAugmentProcessor(), config=config.augment_document)
