...
y_encoder = {"name": "y_encoder", "rnn_cell_fw": {"kwargs": {"num_units": dim}}}

x_encoder = {"name": "x_encoder", "rnn_cell_fw": {"kwargs": {"num_units": dim}}}

rnn_cell = {
    "type": "LSTMBlockCell",
    "kwargs": {"num_units": dim, "forget_bias": 0.0},
    "dropout": {
        "input_keep_prob": 0.8,
        "state_keep_prob": 0.5,
    },
